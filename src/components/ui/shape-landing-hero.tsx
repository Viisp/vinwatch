...
export function HeroGeometric({
  badge = "Gestion financière personnelle",
  title1 = "Maîtrisez vos finances",
  title2 = "simplement.",
  description = "Suivez vos dépenses, planifiez votre budget et simulez vos crédits — tout stocké sur votre appareil.",
}: HeroGeometricProps) {
  ...
  return (
    <div className="relative w-full flex items-center justify-center overflow-hidden py-20 md:py-28">
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/[0.05] via-transparent to-[#00c896]/[0.05] blur-3xl" />
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <ElegantShape delay={0.5} width={500} height={120} rotate={-15} gradient="from-[#00c896]/[0.15]" className="right-[-5%] md:right-[0%] top-[70%] md:top-[75%]" />
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Circle className="h-2 w-2 fill-[#00c896]/80" />
          ...
          <motion.div custom={1} variants={fadeUpVariants} initial="hidden" animate="visible">
            <h1 className="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 tracking-tight">
              ...
              <br />
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-indigo-300 via-white/90 to-[#00c896]">
                {title2}
              </span>
            </h1>
          </motion.div>
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#08111e] via-transparent to-[#08111e]/80 pointer-events-none" />
    </div>
  );
}
